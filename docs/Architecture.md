...
### CorticalNode
This is the actual nodes visible on the graph that represent a cortical area. They listen to various signals of their associated **AbstractCorticalArea** object from the cache to remain up to date with the FEAGI state.
