...
var was_dragging: bool = false # were we dragging before this event? Only true when the last held button is released!


func _init(start_position: Vector3, end_position: Vector3, is_pressed: bool, is_double_clicked: bool, button_involved: CLICK_BUTTON, was_previously_dragging: bool = false):
