...
func FEAGI_set_name(new_name: StringName) -> void:
		if new_name == _name: 
			return
		_name = new_name
...
func FEAGI_set_dimensions(new_dimensions: Vector3i) -> void:
		if new_dimensions == _dimensions: 
			return
		_dimensions = new_dimensions
		dimensions_updated.emit(new_dimensions, self)

func FEAGI_set_2D_coordinates(new_coords: Vector2i) -> void:
...
func FEAGI_set_3D_coordinates(new_coords: Vector3i) -> void:
