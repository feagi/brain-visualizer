...
var _bv_directpoints_renderers_by_id: Dictionary = {} # key: instance_id, value: {renderer, multimesh, dimensions}
...
func FEAGI_change_dimensions_3D(new_dim_3D: Vector3i) -> void:
	...
	for renderer_id in _bv_directpoints_renderers_by_id.keys():
		...
		entry["dimensions"] = _bv_directpoints_dimensions
		_bv_directpoints_renderers_by_id[renderer_id] = entry
...
func BV_register_directpoints_renderer(renderer: Object, multimesh: MultiMesh, dimensions: Vector3) -> void:
	...
	_bv_directpoints_renderers_by_id[renderer_id] = {
		"renderer": renderer,
		"multimesh": multimesh,
...
func BV_unregister_directpoints_renderer(renderer: Object = null) -> void:
	if renderer == null:
...
## Brain Visualizer: indicates when bulk updates are required to reach multiple renderers.
...
func _bv_prune_directpoints_renderers() -> void:
