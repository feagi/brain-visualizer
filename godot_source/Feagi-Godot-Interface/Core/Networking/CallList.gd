...
func GET_GE_circuitDescription(_circuit_file_name: String):
...
func GET_CO_corticalAreas_list_detailed():
	...
	_request_pool.FEAGI_API_Request(request)
	_request_pool.single_FEAGI_request(_address_list.GET_connectome_corticalAreas_list_detailed, HTTPClient.Method.METHOD_GET, _response_functions_ref.GET_CO_corticalAreas_list_detailed)
