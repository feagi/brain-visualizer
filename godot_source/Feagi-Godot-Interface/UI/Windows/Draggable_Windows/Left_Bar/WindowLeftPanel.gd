...
func _ready():
	...
	section_neuron_firing = collapsible_cortical.collapsing_node
	section_post_synaptic_potential = collapsible_cortical.collapsing_node
	section_memory = collapsible_cortical.collapsing_node
	section_cortical_monitoring = collapsible_cortical.collapsing_node
	section_connections = collapsible_cortical.collapsing_node
	section_dangerzone = collapsible_cortical.collapsing_node
