...
func display_cortical_properties(cortical_reference) -> void: #NOTE: Can't type input since we cannot define multiple potential input classes
	...
	_neuron_excitability.current_int = cortical_reference.neuron_excitability
	...
	cortical_reference.neuron_excitability_updated.connect(_feagi_update_Neuron_Excitability)
