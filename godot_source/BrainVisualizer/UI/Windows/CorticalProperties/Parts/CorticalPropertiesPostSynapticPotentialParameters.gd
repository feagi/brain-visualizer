...
func FEAGI_set_PSP_Uniformity(new_val: bool, _duplicate_ref: AbstractCorticalArea):
	_PSP_Uniformity.set_toggle_no_signal(new_val)
	_FEAGI_confirmed_update()

func FEAGI_set_MP_Driven_PSP(new_val: bool, _duplicate_ref: AbstractCorticalArea):
	_MP_Driven_PSP.set_toggle_no_signal(new_val)
	_FEAGI_confirmed_update()

func FEAGI_set_Post_Synaptic_Potential(new_val: float, _duplicate_ref: AbstractCorticalArea):
	_Post_Synaptic_Potential.current_float = new_val
	_FEAGI_confirmed_update()

func FEAGI_set_PSP_Max(new_val: float, _duplicate_ref: AbstractCorticalArea):
