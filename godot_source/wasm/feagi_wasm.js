...
function __wasm_bindgen_func_elem_2777(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_2777(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

const __wbindgen_enum_IdbTransactionMode = ["readonly", "readwrite", "versionchange", "readwriteflush", "cleanup"];

const FeagiEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_feagiengine_free(ptr >>> 0, 1));

/**
 * Main FEAGI neural computation engine
 *
 * This class provides the primary interface for running FEAGI neural networks
 * in WebAssembly. It manages genome loading, burst processing, and state.
 */
export class FeagiEngine {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        FeagiEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_feagiengine_free(ptr, 0);
    }
    /**
     ...
     */
    getConfig() {
        const ret = wasm.feagiengine_getConfig(this.__wbg_ptr);
    ...
    setConfig(config) {
        try {
            ...
            wasm.feagiengine_setConfig(retptr, this.__wbg_ptr, addHeapObject(config));
     ...
     */
    loadGenome(genome_json) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(genome_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.feagiengine_loadGenome(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
     ...
     */
    saveGenome(genome_id) {
        const ptr0 = passStringToWasm0(genome_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.feagiengine_saveGenome(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     ...
     */
    initStorage() {
        const ret = wasm.feagiengine_initStorage(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     ...
     */
    listGenomes() {
        const ret = wasm.feagiengine_listGenomes(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     ...
     * @returns {Promise<void>}
     */
    deleteGenome(genome_id) {
        const ptr0 = passStringToWasm0(genome_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.feagiengine_deleteGenome(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
     ...
     * @param {any} _input_data
     * @returns {string}
     */
    processBurst(_input_data) {
        let deferred2_0;
        let deferred2_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.feagiengine_processBurst(retptr, this.__wbg_ptr, addHeapObject(_input_data));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    downloadGenome() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.feagiengine_downloadGenome(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
     ...
     */
    getBurstCount() {
        const ret = wasm.feagiengine_getBurstCount(this.__wbg_ptr);
     ...
     */
    isGenomeLoaded() {
        const ret = wasm.feagiengine_isGenomeLoaded(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    processBurstFast(_input_data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.feagiengine_processBurstFast(retptr, this.__wbg_ptr, addHeapObject(_input_data));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     * @returns {Promise<void>}
     */
    loadGenomeFromStorage(genome_id) {
        const ptr0 = passStringToWasm0(genome_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.feagiengine_loadGenomeFromStorage(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    ...
    constructor() {
        try {
            ...
            this.__wbg_ptr = r0 >>> 0;
            FeagiEngineFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
     ...
     */
    reset() {
        wasm.feagiengine_reset(this.__wbg_ptr);
    }
    /**
    ...
    getStats() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.feagiengine_getStats(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
if (Symbol.dispose) FeagiEngine.prototype[Symbol.dispose] = FeagiEngine.prototype.free;
 ...
 * @returns {string}
 */
export function decode_type_11(buffer) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.decode_type_11(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_new_ff12d2b041fb48f1 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return __wasm_bindgen_func_elem_2777(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbindgen_cast_46fe3e4a37968b61 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_693, __wasm_bindgen_func_elem_708);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_cast_851eef235b0e7f7e = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_108, __wasm_bindgen_func_elem_310);
        return addHeapObject(ret);
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('feagi_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
